...
int main() {  
    ...
    for (int t = 0; t < time_steps; ++t) {
        ...
        for (unsigned int i = 0; i < map_size; ++i) {
            ...
            auto pseudo_ranges = pseudo_range_estimator(landmark_positions, pseudo_position);
            auto observation = observation_model(
                landmark_positions,
                observations,
                pseudo_ranges,
                distance_max,
            ...
            posteriors[i] = motion_prob * observation;
        ...
        priors = Helpers::normalize_vector(posteriors);
